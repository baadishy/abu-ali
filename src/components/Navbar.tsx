      ...
      <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-3 md:gap-4 flex-1">
          ...
          <div className="flex items-center gap-2 md:gap-4 cursor-pointer min-w-0" onClick={() => navigateTo('/')}>
            <div className="w-10 h-10 md:w-16 md:h-16 rounded-xl md:rounded-2xl overflow-hidden shrink-0 shadow-lg shadow-primary/20 bg-black/10">
              <img
                src="/abu-ali-logo.png"
                alt={(settings?.storeNameAr || settings?.storeName || "Logo") + " logo"}
